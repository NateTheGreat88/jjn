    ...
    for (let i = 1; i < 9; i++) {
        for (let j = 1; j < 9; j++) {
            if (Board.Squares[i][j].piece != undefined) {
                let img = "<img src='images/chess/Pieces/" + Board.Squares[i][j].piece.color + Board.Squares[i][j].piece.name + ".png' width='100%' style='pointer-events:none; user-select: none;'>"
                let square = document.getElementById((i + "" + j));
                square.innerHTML = img;
                square.classList.toggle("squareHover", true);
            }
            else {
                let img = "<img src='images/chess/Pieces/Blank.png' width='100%' style='pointer-events:none; user-select: none;'>"
                let square = document.getElementById((i + "" + j));
                square.innerHTML = img;
...
function addToCapturedPieces(piece, color){
    ...
    if(piece == undefined && color == undefined){
        ...
        let image = "images/chess/Pieces/" + color + piece + ".png";
...
function makePopUp(event){
    ...
    let whiteButton = "<button onclick=chooseSide('White') class='ChooseSideButton'><img src='images/chess/Pieces/WhiteKing.png' height='50vw'></button>";
    let blackButton = "<button onclick=chooseSide('Black') class='ChooseSideButton'><img src='images/chess/Pieces/BlackKing.png' height='50vw'></button>";
...
function makePromotion(color, i, j){
    ...
    if(color != OpponentSide){
        let QueenPromote = "<div class='PromotionOptions' id='QueenPromote'><img src='images/chess/Pieces/"+color+"Queen.png' width='90%' height='90%'></div>";
        let KnightPromote = "<div class='PromotionOptions' id='KnightPromote'><img src='images/chess/Pieces/"+color+"Knight.png' width='90%' height='90%'></div>";
        let RookPromote = "<div class='PromotionOptions' id='RookPromote'><img src='images/chess/Pieces/"+color+"Rook.png' width='90%' height='90%'></div>";
        let BishopPromote = "<div class='PromotionOptions' id='BishopPromote'><img src='images/chess/Pieces/"+color+"Bishop.png' width='90%' height='90%'></div>";
...
function sound(){
    var snd = new Audio("audio/ChessMoveSound.mp3");
    snd.volume = 0.5;
    snd.play();
    snd.currentTime=0;
}
